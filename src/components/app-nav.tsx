...
export function AppNav({ active }: { active: "dashboard" | "history" | "forecast" | "profile" }) {
  ...
  const labels = locale === "uk"
    ? { dashboard: "Огляд", history: "Історія", forecast: "Прогноз", profile: "Профіль", aria: "Основна навігація" }
    : { dashboard: "Dashboard", history: "History", forecast: "Forecast", profile: "Profile", aria: "Primary navigation" };
  return (
