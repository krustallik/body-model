...
export type FatWeightShadowStateV1 = { fatMassKg: number | null; slowNonFatKg: number | null; availability: "available" | "unavailable"; provenance: "legacy-model-initialization" | null; uncertainty: "personal-unavailable" };
